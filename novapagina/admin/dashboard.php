...
<head>
    ...
    <link rel="stylesheet" href="dashassets/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i">
    <link rel="stylesheet" href="dashassets/fonts/fontawesome-all.min.css">
    <style>
        .card-body{
            cursor: pointer;
        }
...
<body id="page-top">
                        ...
                        <div class="card shadow border-left-success py-2">
                            <div class="card-body">
                                <div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-uppercase text-success font-weight-bold text-xs mb-1"><span>Apresentação</span></div>
                                        <div class="text-dark font-weight-bold h5 mb-0"><span>Editar texto de apresentação</span></div>
                                    </div>
                    ...
                    <div class="col-md-6 col-xl-3 mb-4">
                        <div class="card shadow border-left-success py-2">
                            <div class="card-body">
                                <div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-uppercase text-success font-weight-bold text-xs mb-1"><span>Informes</span></div>
                                        <div class="text-dark font-weight-bold h5 mb-0"><span>Editar últimos informes</span></div>
                                    </div>
                    ...
                    <div class="col-md-6 col-xl-3 mb-4">
                        <div class="card shadow border-left-success py-2">
                            <div class="card-body">
                                <div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-uppercase text-success font-weight-bold text-xs mb-1"><span>Alunos</span></div>
                                        <div class="text-dark font-weight-bold h5 mb-0"><span>Editar tabela de alunos</span></div>
                                    </div>
                    ...
                    <div class="col-md-6 col-xl-3 mb-4">
                        <div class="card shadow border-left-success py-2">
                            <div class="card-body">
                                <div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-uppercase text-success font-weight-bold text-xs mb-1"><span>Disciplinas</span></div>
                                        <div class="text-dark font-weight-bold h5 mb-0"><span>Editar tabela de disciplinas</span></div>
                                    </div>
                    ...
                    <div class="col-md-6 col-xl-3 mb-4">
                        <div class="card shadow border-left-success py-2">
                            <div class="card-body">
                                <div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-uppercase text-success font-weight-bold text-xs mb-1"><span>Trabalhos</span></div>
                                        <div class="text-dark font-weight-bold h5 mb-0"><span>Editar página com últimos trabalhos</span></div>
                                    </div>
                    ...
                    <div class="col-md-6 col-xl-3 mb-4">
                        <div class="card shadow border-left-success py-2">
                            <div class="card-body">
                                <div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-uppercase text-success font-weight-bold text-xs mb-1"><span>Cordenação</span></div>
                                        <div class="text-dark font-weight-bold h5 mb-0"><span>Editar informações da coordenação</span></div>
                                    </div>
                    ...
                    <div class="col-md-6 col-xl-3 mb-4">
                        <div class="card shadow border-left-success py-2">
                            <div class="card-body">
                                <div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-uppercase text-success font-weight-bold text-xs mb-1"><span>Professores</span></div>
                                        <div class="text-dark font-weight-bold h5 mb-0"><span>Editar informações dos professores</span></div>
                                    </div>
                    ...
                    <div class="col-md-6 col-xl-3 mb-4">
                        <div class="card shadow border-left-success py-2">
                            <div class="card-body">
                                <div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-uppercase text-success font-weight-bold text-xs mb-1"><span>Eventos</span></div>
                                        <div class="text-dark font-weight-bold h5 mb-0"><span>Editar informações dos eventos</span></div>
                                    </div>
                    ...
                    <div class="col-md-6 col-xl-3 mb-4">
                        <div class="card shadow border-left-success py-2">
                            <div class="card-body">
                                <div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-uppercase text-success font-weight-bold text-xs mb-1"><span>Seminários e Palestras</span></div>
                                        <div class="text-dark font-weight-bold h5 mb-0"><span>Editar seminários e palestras</span></div>
                                    </div>
    ...
    <script src="dashassets/js/jquery.min.js"></script>
    <script src="dashassets/bootstrap/js/bootstrap.min.js"></script>
    <script src="dashassets/js/chart.min.js"></script>
    <script src="dashassets/js/bs-init.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.4.1/jquery.easing.js"></script>
    <script src="dashassets/js/theme.js"></script>
</body>
