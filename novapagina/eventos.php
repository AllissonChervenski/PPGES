...
include("header.html");
?>
        <section class="clean-block features" style="padding-bottom: 6px;" id="next-section">
            <div class="container" id="secontainer">
                ...
                <div id="my-divent2" class="block-heading bordering">
                    ...
                    <p class="text-justify"
                        ...
                        between these three areas, and also motivated by the fact that the design of computing
                        systems is an increasingly multidisciplinary task. Since 2013, the <strong>Brazilian
                            Conference on Critical Embedded Systems </strong>(CBSEC)
                        is also part of SBESC. In order to further strengthen the integration between these
                        communities and to better represent the interdisciplinarity found in many research
                        initiatives, since 2015 SBESC is no longer divided into separated tracks. Instead,
                        a broad list of topics of interest is presented, covering the main aspects of the original
                        SBESC tracks. SBESC 2019 became an IEEE-IES sponsored event.<br /><br />





                        <a href="https://cbsoft2019.ufba.br/#/cbsoft"><span style="  text-decoration: underline;">
                                The Brazilian Conference on Software: Theory and Practice (CBSoft)</span></a> is an
                        annual
                        event promoted by the Brazilian Computer Society (SBC), aiming at promoting and encouraging the
                        exchange of experiences among researchers and practioneers from
                        the industry and academia on the latest research, trends and innovations – practical and
                        theoretical – concerning software. Held since 2010, CBSoft has become one of the most important
                        events of the Brazilian scientific computing community, and each
                        year the numbers of submissions of scientific papers and participants have been increasing. 
                        CBSoft 2019 integrates four traditional events organized by the Brazilian software development
                        community: <strong>XXXIII Brazilian Symposium on Software Engineering</strong> (
                        <a href="https://cbsoft2019.ufba.br/#/sbes"><span style="  text-decoration: underline;">
                                SBES 2019</span></a>) <strong>XXIII Brazilian Symposium on Programming
                            Languages </strong>(
                        <a href="https://cbsoft2019.ufba.br/#/sblp"><span style="  text-decoration: underline;">
                                SBLP 2019</span></a>)<strong> XIII Brazilian Symposium on Components, Architectures and
                            Software Reuse</strong> (<a href="https://cbsoft2019.ufba.br/#/sbcars"><span
                                style="  text-decoration: underline;">
                                SBCARS 2019</span></a>) <strong>IV Brazilian Symposium on Systematic and Automated
                            Software
                            Testing</strong> (
                        <a href="https://cbsoft2019.ufba.br/#/sast"><span style="  text-decoration: underline;">
                                SAST 2019</span></a>).
                ...
                <div id="my-divent3" class="block-heading bordering">
                    ...
                    <p id="internacionais" class="text-justify"
                        ...
                        <a href="https://ladc2019.imd.ufrn.br/index.html"><span style="  text-decoration: underline;">
                                9th Latin-American Symposium on Dependable Computing</span></a>. LADC is the major
                        Latin-American event on computer system dependability. The LADC 2019 program will present
                        technical sessions, workshops, tutorials, fast abstracts, keynote talks from
                        international experts in the area and an industrial track. The symposium scope includes recent
                        research results on software and system dependability. LADC is the Latin-American event oriented
                        to disseminate computer system dependability and security
                        research advances. This year, LADC 2019 will be held in conjunction with the <a
                            href="http://sbesc.lisha.ufsc.br/sbesc2017/"><span style="  text-decoration: underline;">IX
                                Brazilian Symposium on Computing Systems Engineering (SBESC)</span></a> in Natal, Brazil
                        from the 19th to the 21st of November 2019. The LADC symposium scope includes both dependability
                        and security research works, as well as research on the technological
                        challenges that they entail for the design, verification and validation and maintenance of
                        systems, software, and hardware.<br /><br />


                        <a href="http://eseiw2019.com/esem/"><span style="  text-decoration: underline;">
                                The ACM/IEEE International Symposium on Empirical Software Engineering and Measurement
                                (ESEM)</span></a> is the
                        premier conference for presenting research results related to empirical software engineering.
                        ESEM provides a stimulating forum where researchers
                        and practitioners can present and discuss recent research results on a wide range of topics, in
                        addition to exchanging ideas, experiences and challenging problems. The 13th edition of ESEM
                        will be held in Porto de Galinhas, Brazil, from September
                        16th to 20th, 2019 as part of the Empirical Software Engineering International Week.<br /><br />
                        ...
                        areas such: theories of concepts underlying conceptual modeling, methods and tools for
                        developing and communicating conceptual models, techniques for transforming
                        conceptual models into effective implementations, and the impact of conceptual modeling
                        techniques on databases, business strategies and information systems development.<br /><br />
                    </p>
